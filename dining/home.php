...
<head>
  ...
  <title>RPI Dining — Ship Log</title>
  <style>
...
<div id="hud">
  <div class="title">RPI <span>Dining</span> — Ship Log</div>
...
<div id="viewport">
  <div id="map">
    ...
    <div class="node node-meal" id="node-commons-lunch" style="left:1000px; top:550px;" onclick="openPanel('panel-commons-lunch')">
      ...
      <div class="meal-hours">11:00 AM – 3:30 PM</div>
    ...
    <div class="node node-meal" id="node-commons-dinner" style="left:1000px; top:680px;" onclick="openPanel('panel-commons-dinner')">
      ...
      <div class="meal-hours">4:30 PM – 9:00 PM</div>
      <div class="expand-hint">▶ TAP TO EXPAND</div>
    </div>
    ...
    <div class="node node-meal" id="node-sage-lunch" style="left:1840px; top:550px;" onclick="openPanel('panel-sage-lunch')">
      ...
      <div class="meal-hours">11:00 AM – 2:30 PM</div>
      <div class="expand-hint">▶ TAP TO EXPAND</div>
    </div>
    ...
    <div class="node node-meal" id="node-sage-dinner" style="left:1840px; top:680px;" onclick="openPanel('panel-sage-dinner')">
      ...
      <div class="meal-hours">4:00 PM – 8:00 PM</div>
      <div class="expand-hint">▶ TAP TO EXPAND</div>
    </div>
...
<div class="node-panel" id="panel-commons">
  ...
  <div class="panel-body">
    ...
    <div class="panel-section">
      ...
      <div class="hours-row"><span class="day">Mon–Fri Lunch</span><span class="time">11:00 AM – 3:30 PM</span></div>
      <div class="hours-row"><span class="day">Mon–Sun Dinner</span><span class="time">4:30 PM – 9:00 PM</span></div>
      <div class="hours-row"><span class="day">Sat–Sun Late Lunch</span><span class="time">2:00 PM – 4:30 PM</span></div>
    </div>
...
<div class="node-panel" id="panel-sage">
  ...
  <div class="panel-body">
    ...
    <div class="panel-section">
      <div class="panel-section-title">Hours of Operation</div>
      <div class="hours-row"><span class="day">Mon–Fri Breakfast</span><span class="time">7:00 AM – 10:00 AM</span></div>
      <div class="hours-row"><span class="day">Mon–Fri Lunch</span><span class="time">11:00 AM – 2:30 PM</span></div>
      <div class="hours-row"><span class="day">Mon–Fri Late Lunch</span><span class="time">2:30 PM – 4:00 PM</span></div>
      <div class="hours-row"><span class="day">Mon–Sun Dinner</span><span class="time">4:00 PM – 8:00 PM</span></div>
      <div class="hours-row"><span class="day">Sat–Sun Late Lunch</span><span class="time">1:30 PM – 4:00 PM</span></div>
    </div>
...
<div class="node-panel" id="panel-commons-lunch">
  <div class="panel-header">
    <div class="panel-title lunch">Commons — Lunch</div>
    <button class="panel-close" onclick="closeAllPanels()">[ CLOSE ]</button>
  </div>
  <div class="panel-body">
    ...
    <div class="panel-section">
      ...
      <div class="hours-row"><span class="day">Mon–Fri</span><span class="time">11:00 AM – 3:30 PM</span></div>
      <div class="hours-row"><span class="day">Sat–Sun</span><span class="time">Late Lunch: 2:00 PM – 4:30 PM</span></div>
    </div>
    <div class="panel-section">
...
<div class="node-panel" id="panel-commons-dinner">
  <div class="panel-header">
    <div class="panel-title dinner">Commons — Dinner</div>
    <button class="panel-close" onclick="closeAllPanels()">[ CLOSE ]</button>
  </div>
  <div class="panel-body">
    ...
    <div class="panel-section">
      <div class="panel-section-title">Hours</div>
      <div class="hours-row"><span class="day">Mon–Sun</span><span class="time">4:30 PM – 9:00 PM</span></div>
    </div>
    <div class="panel-section">
      <div class="panel-section-title">Today's Menu</div>
...
<div class="node-panel" id="panel-sage-lunch">
  <div class="panel-header">
    <div class="panel-title lunch">Russell Sage — Lunch</div>
    <button class="panel-close" onclick="closeAllPanels()">[ CLOSE ]</button>
  </div>
  <div class="panel-body">
    ...
    <div class="panel-section">
      <div class="panel-section-title">Hours</div>
      <div class="hours-row"><span class="day">Mon–Fri</span><span class="time">11:00 AM – 2:30 PM</span></div>
      <div class="hours-row"><span class="day">Sat–Sun</span><span class="time">Late Lunch: 1:30 PM – 4:00 PM</span></div>
    </div>
    <div class="panel-section">
      <div class="panel-section-title">Today's Menu</div>
...
<div class="node-panel" id="panel-sage-dinner">
  <div class="panel-header">
    <div class="panel-title dinner">Russell Sage — Dinner</div>
    <button class="panel-close" onclick="closeAllPanels()">[ CLOSE ]</button>
  </div>
  <div class="panel-body">
    ...
    <div class="panel-section">
      <div class="panel-section-title">Hours</div>
      <div class="hours-row"><span class="day">Mon–Sun</span><span class="time">4:00 PM – 8:00 PM</span></div>
    </div>
    <div class="panel-section">
      <div class="panel-section-title">Today's Menu</div>
...
<div id="controls">
  ...
  <button class="ctrl-btn" onclick="zoom(-0.15)">−</button>
  <button class="ctrl-btn" onclick="resetView()" style="font-size:9px;letter-spacing:0;">⌖</button>
</div>
...
function checkMealTimes() {
  ...
  // Panel status
  setMealStatus('status-commons-lunch', commonsLunch, '11:00 AM – 3:30 PM');
  setMealStatus('status-commons-dinner', commonsDinner, '4:30 PM – 9:00 PM');
  setMealStatus('status-sage-lunch', sageLunch, '11:00 AM – 2:30 PM');
  setMealStatus('status-sage-dinner', sageDinner, '4:00 PM – 8:00 PM');
}
...
function setMealStatus(id, isOpen, hours) {
  ...
  if (isOpen) {
    ...
    el.textContent = `● OPEN NOW  ·  ${hours}`;
  } else {
    el.className = 'menu-status closed';
    el.textContent = `○ CLOSED  ·  Opens ${hours}`;
  }
}
  ...
  try {
    ...
    container.innerHTML = `
      <div style="font-size:9px;color:var(--text-dim);line-height:1.8;grid-column:1/-1">
        <div style="color:var(--orange);margin-bottom:8px;">⚠ MENU UNAVAILABLE</div>
...
function renderMenu(data, meal, container) {
  // Parse Sodexo's JSON structure — they nest under meal periods
  let items = [];
